...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "5813212548:AAG1503Ilf2se-uiHkWwNSxPSr20v0yL6Oo"  # API key obtained from BotFather
    OWNER_ID = "1983530070"  # If you dont know, run the bot and do /id in your private chat with the bot

    # FOR AUTOMATICALLY FORWARDING MESSAGES
    FROM_CHATS = [-1001512321422]  # List of chat id's to forward messages from
    TO_CHATS = [-100691135626]  # List of chat id's to forward messages to
